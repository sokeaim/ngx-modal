...
# ngx-modal, this source take from https://github.com/pleerock/ngx-modal

# ngx-modal

Open modal window (dialog box) for your angular8 applications using bootstrap3. If you don't want to use it without bootstrap - simply create proper css classes. Please star a project if you liked it, or create an issue if you have problems with it.
...
Take a look on samples in [./sample](https://github.com/sokeaim/ngx-modal/tree/master/sample) for more examples of
usages.
